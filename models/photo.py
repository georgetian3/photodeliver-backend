...
class BasePhoto(SQLModel):
    album_id: UUID = Field(foreign_key="album.id", ondelete="CASCADE") # the album to which this photo belongs
    section_id: UUID | None = Field(foreign_key="albumsection.id", ondelete="CASCADE") # the section to which this photo belongs, can be null
